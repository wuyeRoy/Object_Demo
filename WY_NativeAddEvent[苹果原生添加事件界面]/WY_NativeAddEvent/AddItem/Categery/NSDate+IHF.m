...
+ (NSString *)weekStringFromString:(NSString *)string format:(NSString *)format
{
    NSDate *date = [NSDate dateFromString:string format:format];
...
+ (NSString *)weekTowTypeStringFromString:(NSString *)string format:(NSString *)format
{
    NSDate *date = [NSDate dateFromString:string format:format];
    NSInteger weekday = [date weekday];
    NSString *weekStr;
...
+ (NSString *)stringFromString:(NSString *)string form_format:(NSString *)form to_tormat:(NSString *)to
{
    NSDate *date = [NSDate dateFromString:string format:form];
    return [date stringWithFormat:to];
}
